...
router.post('/', async(req, res) => {        //async para esperar alguma açao dentro da rota
...
router.get('/:id', async(req,res) => {      //Lá no postman, precisamos colocar a url com o ID do user (que aparece no mongoDB)
...
router.patch('/:id', async(req,res) => {
    ...
    const person = {
        nome, cpf, cnh, email, contato, cartao
    }
